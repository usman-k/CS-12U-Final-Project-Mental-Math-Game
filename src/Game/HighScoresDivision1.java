 ...
 *
 */
public class HighScoresDivision1 {
	...
	public static void work() {
		...
		try {
			readFile("HighScoresDivision1.txt");
		}catch (IOException e) {
		...
		JLabel info = new JLabel("HIGHSCORES - THESE ARE THE FASTEST TIMES FOR DIVISION DIFFICULTY 1!");
		m.gridx = 1;
		m.gridy = 0;
		panel.add(info, m);
	...
	public static void writeFile() throws IOException {
		PrintWriter pw = new PrintWriter(new FileWriter("HighScoresDivision1.txt"));
