 ...
 *
 */
public class HighScoresAddition4 {
	...
	public static void work() {
		...
		try {
			readFile("HighScoresAddition4.txt");
		}catch (IOException e) {
		...
		JLabel info = new JLabel("HIGHSCORES - THESE ARE THE FASTEST TIMES FOR ADDITION DIFFICULTY 4!");
		m.gridx = 1;
		m.gridy = 0;
		panel.add(info, m);
	...
	public static void writeFile() throws IOException {
		PrintWriter pw = new PrintWriter(new FileWriter("HighScoresAddition4.txt"));
