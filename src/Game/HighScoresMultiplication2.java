 ...
 *
 */
public class HighScoresMultiplication2 {
	...
	public static void work() {
		...
		try {
			readFile("HighScoresMultiplication2.txt");
		}catch (IOException e) {
		...
		JLabel info = new JLabel("HIGHSCORES - THESE ARE THE FASTEST TIMES FOR MULTIPLICATION DIFFICULTY 2!");
		m.gridx = 1;
		m.gridy = 0;
		panel.add(info, m);
	...
	public static void writeFile() throws IOException {
		PrintWriter pw = new PrintWriter(new FileWriter("HighScoresMultiplication2.txt"));
