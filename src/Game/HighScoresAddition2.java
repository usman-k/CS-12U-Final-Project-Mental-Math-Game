 ...
 *
 */
public class HighScoresAddition2 {
	 ...
	 * (See Addition class and HighScoresAddition1 class if more in depth commenting is required)
	 */
	public static void work() {
		...
		try {
			readFile("HighScoresAddition2.txt");
		}catch (IOException e) {
		...
		JLabel info = new JLabel("HIGHSCORES - THESE ARE THE FASTEST TIMES FOR ADDITION DIFFICULTY 2!");
		m.gridx = 1;
		m.gridy = 0;
		panel.add(info, m);
	...
	public static void writeFile() throws IOException {
		PrintWriter pw = new PrintWriter(new FileWriter("HighScoresAddition2.txt"));
