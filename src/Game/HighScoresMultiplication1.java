 ...
 *
 */
public class HighScoresMultiplication1 {
	...
	public static void work() {
		...
		try {
			readFile("HighScoresMultiplication1.txt");
		}catch (IOException e) {
			
		}
		
		Multiplication mul = new Multiplication();
		secs = (double) mul.getDouble();
		...
		JLabel info = new JLabel("HIGHSCORES - THESE ARE THE FASTEST TIMES FOR MULTIPLICATION DIFFICULTY 1!");
		m.gridx = 1;
		m.gridy = 0;
		panel.add(info, m);
	...
	public static void writeFile() throws IOException {
		PrintWriter pw = new PrintWriter(new FileWriter("HighScoresMultiplication1.txt"));
