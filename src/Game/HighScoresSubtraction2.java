 ...
 *
 */
public class HighScoresSubtraction2 {
	...
	public static void work() {
		...
		try {
			readFile("HighScoresSubtraction2.txt");
		}catch (IOException e) {
		...
		JLabel info = new JLabel("HIGHSCORES - THESE ARE THE FASTEST TIMES FOR SUBTRACTION DIFFICULTY 2!");
		m.gridx = 1;
		m.gridy = 0;
		panel.add(info, m);
	...
	public static void writeFile() throws IOException {
		PrintWriter pw = new PrintWriter(new FileWriter("HighScoresSubtraction2.txt"));
