 ...
 *
 */
public class HighScoresAddition3 {
	...
	public static void work() {
		...
		try {
			readFile("HighScoresAddition3.txt");
		}catch (IOException e) {
		...
		JLabel info = new JLabel("HIGHSCORES - THESE ARE THE FASTEST TIMES FOR ADDITION DIFFICULTY 3!");
		m.gridx = 1;
		m.gridy = 0;
		panel.add(info, m);
	...
	public static void writeFile() throws IOException {
		PrintWriter pw = new PrintWriter(new FileWriter("HighScoresAddition3.txt"));
